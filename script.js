...
function specialWish() {
  const wishes = [
    "🌟 Chúc chị Ngọc luôn rạng rỡ như trăng rằm! 🌟",
    "💫 Trung Thu ấm áp, hạnh phúc ngập tràn! 💫",
    "🎋 Chúc chị sức khỏe, thành công rực rỡ! 🎋",
    "🏮 Ánh trăng soi đường, may mắn đầy nhà! 🏮",
    "🌙 Trăng tròn người tròn, hạnh phúc viên mãn! 🌙",
  ];
